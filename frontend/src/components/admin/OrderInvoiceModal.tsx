        ...
        {loading ? (
          ...
          <div className="space-y-6 text-sm font-body-md">
            ...
            <div className="grid grid-cols-2 gap-6 bg-surface-container/30 p-4 rounded-lg border border-outline-variant/40 text-xs">
              ...
              <div>
                ...
                <p className="text-on-surface-variant">
                  Phương thức: <span className="font-bold text-primary">{order.paymentMethod === 'VNPAY' ? 'Thanh toán trực tuyến VNPay' : 'Thanh toán COD (Khi nhận hàng)'}</span>
                </p>
                <p className="text-on-surface-variant">
            ...
            <div className="flex justify-end pt-2">
              <div className="w-72 space-y-2 text-xs border-t border-outline-variant/60 pt-3">
            ...
            {/* Signatures */}
            <div className="grid grid-cols-2 gap-8 text-center pt-10 border-t border-outline-variant/40 text-xs">
              <div>
